...
```{r, echo=FALSE, out.width='800pt', fig.align = 'center', fig.cap="Title page"}
knitr::include_graphics("img/Ref_1_title.png")
```

Next, navigate to the `Reference` tab:

```{r, echo=FALSE, out.width='800pt', fig.align = 'center', fig.cap="Reference"}
knitr::include_graphics("img/Ref_2_ref_empty.png")
```

Clicking on the `Choose Reference Path` to choose a reference path.
A dialog box will pop up. Select the path to the reference folder
on the left hand box as shown:

```{r, echo=FALSE, out.width='800pt', fig.align = 'center', fig.cap="Reference path dialog box"}
...
```{r, echo=FALSE, out.width='800pt', fig.align = 'center', fig.cap="Select species"}
...
```{r, echo=FALSE, out.width='800pt', fig.align = 'center', fig.cap="Select Ensembl release"}
knitr::include_graphics("img/Ref_5_version.png")
```

Next, select the correct GTF file:

```{r, echo=FALSE, out.width='800pt', fig.align = 'center', fig.cap="Select GTF file"}
...
```{r, echo=FALSE, out.width='800pt', fig.align = 'center', fig.cap="Select FASTA file"}
...
```{r, echo=FALSE, out.width='800pt', fig.align = 'center', fig.cap="Supply custom FASTA/GTF files"}
...
```{r, echo=FALSE, out.width='800pt', fig.align = 'center', fig.cap="Select defaults for hg38"}
...
```{r, echo=FALSE, out.width='800pt', fig.align = 'center', fig.cap="Ready to run Reference"}
...
```{r, echo=FALSE, out.width='800pt', fig.align = 'center', fig.cap="Running BuildReference"}
knitr::include_graphics("img/Ref_11_progress.png")
```

When this is completed:

```{r, echo=FALSE, out.width='800pt', fig.align = 'center', fig.cap="Reference build complete"}
knitr::include_graphics("img/Ref_11_progress.png")
```
