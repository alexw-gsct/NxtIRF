...
FragmentsMap::FragmentsMap() {
  chrName_count[0] = new std::map<string, std::map<unsigned int, int> >();
  chrName_count[1] = new std::map<string, std::map<unsigned int, int> >();
  chrName_count[2] = new std::map<string, std::map<unsigned int, int> >();
}
...
FragmentsMap::~FragmentsMap() {
  ...
  // chrName_count[2].clear();
	delete chrName_count[0];
	delete chrName_count[1];
	delete chrName_count[2];
}
